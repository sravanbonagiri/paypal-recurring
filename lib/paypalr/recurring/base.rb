module PayPalr
  module Recurring
    class Base
      ...
      #     :ipn_url            => "http://example.com/PayPalr/ipn",
      ...
      #
      #   ppr = PayPalr::Recurring.new(:profile_id => "I-HYRKXBMNLFSK")
      ...
      #
      #   ppr = PayPalr::Recurring.new(:token => "EC-6LX60229XS426623E")
      ...
      #
      #   ppr = PayPalr::Recurring.new(:profile_id => "I-VCEL6TRG35CU")
